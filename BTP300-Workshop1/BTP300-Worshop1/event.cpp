...
namespace seneca {
    ...
    std::ostream& operator<<(std::ostream& out, Event& event){
        ...
        if (g_settings.m_time_units == "seconds") {
            ...
            out << std::setw(2) << time.count() << "seconds" << std::endl;
            ...
            out << std::setw(2) << time.count() << "milliseconds" << std::endl;
            ...
            out << std::setw(2) << time.count() << "microseconds" << std::endl;
            ...
            out << std::setw(2) << time.count() << "nanoseconds" << std::endl;
        }
